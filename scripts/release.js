...
// Extract framework.version from .codex/config.yml without taking a YAML
...
function releaseChecks() {
  ...
  if (configVersion === null) {
    errors.push(`.codex/config.yml is missing framework.version`);
  } else if (configVersion !== version) {
    errors.push(
      `.codex/config.yml framework.version ${configVersion} does not match VERSION ${version}`,
    );
  }
