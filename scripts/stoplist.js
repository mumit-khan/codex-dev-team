...
// track regardless of size or area. Defined in .codex/rules/pipeline.md
// Stage 0. The lighter tracks (/quick, /nano, /config-only, /dep-update)
// must not be used to bypass this list, so codex-team.js calls
...
// Convenience entry point used by codex-team.js. Returns an array of
...
function explainMatches(matches) {
  ...
  lines.push("Stoplist defined in .codex/rules/pipeline.md §Stage 0.");
  return lines.join("\n");
}
