...
|---|---|---|---|---|
| **B-4** | Add `description` to every property in `schemas/*.schema.json` | XS | Low | Direct copy of the prose from claude's schemas with $id/title swapped to codex. No structural change. |
